...
public class XueshengtiwenView extends XueshengtiwenEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 时间类型的值
		*/
		private String xueshengtiwenValue;
	...
	public XueshengtiwenView(XueshengtiwenEntity xueshengtiwenEntity) {
		try {
			...
			* 获取： 时间类型的值
			*/
			public String getXueshengtiwenValue() {
				return xueshengtiwenValue;
			}
			/**
			* 设置： 时间类型的值
			*/
			public void setXueshengtiwenValue(String xueshengtiwenValue) {
				this.xueshengtiwenValue = xueshengtiwenValue;
			}
