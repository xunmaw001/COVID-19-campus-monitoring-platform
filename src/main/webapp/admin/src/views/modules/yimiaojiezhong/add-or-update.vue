    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="标题" prop="yimiaojiezhongName">
                       <el-input v-model="ruleForm.yimiaojiezhongName"
                                 placeholder="标题" clearable  :readonly="ro.yimiaojiezhongName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="标题" prop="yimiaojiezhongName">
                           <el-input v-model="ruleForm.yimiaojiezhongName"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="接种状态" prop="yimiaojiezhongTypes">
                        <el-select v-model="ruleForm.yimiaojiezhongTypes" :disabled="ro.yimiaojiezhongTypes" placeholder="请选择接种状态">
                            <el-option
                                v-for="(item,index) in yimiaojiezhongTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="接种状态" prop="yimiaojiezhongValue">
                        <el-input v-model="ruleForm.yimiaojiezhongValue"
                            placeholder="接种状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="接种时间" prop="yimiaojiezhongTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.yimiaojiezhongTime"
                                type="datetime"
                                placeholder="接种时间"
                                :disabled="ro.yimiaojiezhongTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yimiaojiezhongTime" label="接种时间" prop="yimiaojiezhongTime">
                            <span v-html="ruleForm.yimiaojiezhongTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="yimiaojiezhongContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.yimiaojiezhongContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yimiaojiezhongContent" label="备注" prop="yimiaojiezhongContent">
                            <span v-html="ruleForm.yimiaojiezhongContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    yimiaojiezhongName: false,
                    yonghuId: false,
                    yimiaojiezhongTypes: false,
                    yimiaojiezhongTime: false,
                    yimiaojiezhongContent: false,
                },
                ruleForm: {
                    yimiaojiezhongName: '',
                    yonghuId: '',
                    yimiaojiezhongTypes: '',
                    yimiaojiezhongTime: '',
                    yimiaojiezhongContent: '',
                },
                yimiaojiezhongTypesOptions : [],
                yonghuOptions : [],
                rules: {
                   yimiaojiezhongName: [
                   ...
                   yimiaojiezhongTypes: [
                              { required: true, message: '接种状态不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yimiaojiezhong_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yimiaojiezhongTypesOptions = data.data.list;
                    }
                });
