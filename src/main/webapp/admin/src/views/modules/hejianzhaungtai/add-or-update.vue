    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="标题" prop="hejianzhaungtaiName">
                       <el-input v-model="ruleForm.hejianzhaungtaiName"
                                 placeholder="标题" clearable  :readonly="ro.hejianzhaungtaiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="标题" prop="hejianzhaungtaiName">
                           <el-input v-model="ruleForm.hejianzhaungtaiName"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="检测状态" prop="hejianzhaungtaiTypes">
                        <el-select v-model="ruleForm.hejianzhaungtaiTypes" :disabled="ro.hejianzhaungtaiTypes" placeholder="请选择检测状态">
                            <el-option
                                v-for="(item,index) in hejianzhaungtaiTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="检测状态" prop="hejianzhaungtaiValue">
                        <el-input v-model="ruleForm.hejianzhaungtaiValue"
                            placeholder="检测状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="检测时间" prop="hejianzhaungtaiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.hejianzhaungtaiTime"
                                type="datetime"
                                placeholder="检测时间"
                                :disabled="ro.hejianzhaungtaiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.hejianzhaungtaiTime" label="检测时间" prop="hejianzhaungtaiTime">
                            <span v-html="ruleForm.hejianzhaungtaiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="详情" prop="hejianzhaungtaiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.hejianzhaungtaiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.hejianzhaungtaiContent" label="详情" prop="hejianzhaungtaiContent">
                            <span v-html="ruleForm.hejianzhaungtaiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    hejianzhaungtaiName: false,
                    yonghuId: false,
                    hejianzhaungtaiTypes: false,
                    hejianzhaungtaiTime: false,
                    hejianzhaungtaiContent: false,
                },
                ruleForm: {
                    hejianzhaungtaiName: '',
                    yonghuId: '',
                    hejianzhaungtaiTypes: '',
                    hejianzhaungtaiTime: '',
                    hejianzhaungtaiContent: '',
                },
                hejianzhaungtaiTypesOptions : [],
                yonghuOptions : [],
                rules: {
                   hejianzhaungtaiName: [
                   ...
                   hejianzhaungtaiTypes: [
                              { required: true, message: '检测状态不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=hejianzhaungtai_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.hejianzhaungtaiTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`hejianzhaungtai/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.hejianzhaungtaiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
