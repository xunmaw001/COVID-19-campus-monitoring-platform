    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="体温" prop="xueshengtiwenTiwen">
                       <el-input v-model="ruleForm.xueshengtiwenTiwen"
                                 placeholder="体温" clearable  :readonly="ro.xueshengtiwenTiwen"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="体温" prop="xueshengtiwenTiwen">
                           <el-input v-model="ruleForm.xueshengtiwenTiwen"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="时间类型" prop="xueshengtiwenTypes">
                        <el-select v-model="ruleForm.xueshengtiwenTypes" :disabled="ro.xueshengtiwenTypes" placeholder="请选择时间类型">
                            <el-option
                                v-for="(item,index) in xueshengtiwenTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="时间类型" prop="xueshengtiwenValue">
                        <el-input v-model="ruleForm.xueshengtiwenValue"
                            placeholder="时间类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="身体详情" prop="xueshengtiwenContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.xueshengtiwenContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xueshengtiwenContent" label="身体详情" prop="xueshengtiwenContent">
                            <span v-html="ruleForm.xueshengtiwenContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    xueshengtiwenTiwen: false,
                    xueshengtiwenTypes: false,
                    insertTime: false,
                    xueshengtiwenContent: false,
                },
                ruleForm: {
                    yonghuId: '',
                    xueshengtiwenTiwen: '',
                    xueshengtiwenTypes: '',
                    insertTime: '',
                    xueshengtiwenContent: '',
                },
                xueshengtiwenTypesOptions : [],
                yonghuOptions : [],
                rules: {
                   yonghuId: [
                   ...
                   xueshengtiwenContent: [
                              { required: true, message: '身体详情不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xueshengtiwen_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xueshengtiwenTypesOptions = data.data.list;
                    }
                });
